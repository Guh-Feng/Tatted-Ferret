...
<svelte:head>
	<title>
		@carlosdotnet Portfolio
	</title>
	<meta name="description" content="Take a look at @carlosdotnet's tattoo portfolio here.">
</svelte:head>

<img class="absolute flex flex-col lg:hidden top-[20.5vw] w-[100%] h-auto -z-10 select-none" src="../artists/mobile_carlosdotnet.png" alt="instagram screen"/>
<img class="absolute hidden lg:flex lg:w-[118vh] lg:h-[100vh] lg:left-[30vw] lg:max-h-none lg:max-w-none -z-10 select-none" src="../artists/carlosdotnet.png" alt="instagram screen"/>
...
<div class="relative flex flex-col w-[100%] h-[138vw] max-h-none max-w-none lg:flex-row lg:w-[118vh] lg:h-[100vh] lg:left-[30vw] select-none">
	...
	<a class="relative h-auto w-[54.1%] top-[27%] left-[22.7%] lg:h-[42%] lg:w-auto lg:left-[42.3%] lg:top-[27.7%]" href="https://instagram.com/carlosdotnet" target="_blank"><img class="relative -z-10 h-[100%] w-[100%] select-none" src="../artists/carlos/carlos{imageSelection}.png" alt="slideshow of tattoos"></a>
