...
<div class="relative flex flex-col w-[100%] h-[138vw] max-h-none max-w-none lg:flex-row lg:w-[118vh] lg:h-[100vh] lg:left-[30vw] select-none">
	...
	<a class="relative h-auto w-[54.1%] top-[27%] left-[22.7%] lg:h-[42%] lg:w-auto lg:left-[42.3%] lg:top-[27.7%]" href="https://instagram.com/tatterjae?igshid=OGQ5ZDc2ODk2ZA==" target="_blank"><img class="relative -z-10 h-[100%] w-[100%] select-none" src="../artists/carlos/carlos{imageSelection}.png" alt="slideshow of tattoos"></a>
